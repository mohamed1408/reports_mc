...
@Component({
  selector: 'app-prdsalesrpt',
  templateUrl: './prdsalesrpt.component.html',
  styleUrls: ['./prdsalesrpt.component.scss'],
})
export class PrdsalesrptComponent implements OnInit {
